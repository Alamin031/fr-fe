...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        "peer data-[state=checked]:bg-black data-[state=unchecked]:bg-gray-300 focus-visible:border-gray-400 focus-visible:ring-gray-400/50 inline-flex h-6 w-11 shrink-0 items-center rounded-full border-2 border-transparent shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:disabled:bg-gray-600",
        className
      )}
      {...props}
    >
