          ...
          {products.map((product) => {
            ...
            return (
              <CardWrapper key={product._id}>
                <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer transform hover:-translate-y-1">
                  {/* Store Header */}
                  <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-sm">FRIENDSTELECOM</span>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <div className="text-xs">
                        ...
                        <div className="text-gray-500">Reseller</div>
                      </div>
                    </div>
                  </div>
                   {/* Product Name */}
                  <div className="px-4 pt-4 flex justify-center">
                    <h3 className="text-xs text-gray-500 mb-1 uppercase tracking-wide">
                      {product.name}
                    </h3>
                  </div>

                  {/* Product Image */}
                  <div className="relative p-8 flex items-center justify-center bg-gradient-to-br from-gray-50 to-white h-64">
                  ...
                  {/* Badges */}
                  <div className=" py flex flex-wrap bg-gray-900 mx-5">
                    <span className=" text-white text-[6px] px-2 py-1 rounded">
                      100% ORIGINAL
                    </span>
                    <span className=" text-white text-[6px] px-2 py-1 rounded">
                  ...
                  <div className="px-6 pb-3">
                    <h2 className="text-xl font-semibold mt-5 text-gray-900 mb-2 uppercase">
                      {product.name}
                    </h2>
                    <div className="mb-3">
                      <p className="text-xs text-gray-600 mb-1">Mulai dari:</p>
                      <p className="text-xl font-bold text-green-600">
                        {formatPrice(product.price)}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Atau cicilan:</p>
                      <div className="flex items-center gap-2">
                        <p className="text-sm font-semibold text-gray-900">
                          {calculateInstallment(product.price)}/bln
                        </p>
