...
const Upadatanav: React.FC = () => {
    ...
    const navItems: NavItem[] = [
        ...
        { name: 'Mac', href: '/', icon: Monitor },
        { name: 'iPad', href: '/ipad', icon: Tablet }
    ];

    return (
        <nav className="bg-white shadow-md border-b border-gray-200 max-sm:ml-20 sm:w-[1280px] z-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="md:hidden">
                        <button
                            onClick={toggleMenu}
                            className="text-gray-800 hover:text-blue-600 focus:outline-none focus:text-blue-600 p-2"
                    ...
                    {/* Right side - could add search or other elements */}
