            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
                  ...
                  {product.colorImageConfigs.map((color) => (
                    <div key={color.id} className="text-center">
                      <button
                        ...
                        className={`relative p-2 border-4 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                          selectedOptions.color === color.id 
                            ? "border-blue-600 shadow-lg transform scale-110" 
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 font-semibold text-lg rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    addingToCart
                      ? "bg-gray-400 text-gray-600 cursor-not-allowed"
                      : "bg-blue-600 text-white hover:bg-blue-700 active:transform active:scale-[0.98] shadow-lg hover:shadow-xl"
                  }`}
                >
                  {addingToCart ? (
                    ...
                    <span className="flex items-center justify-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.293 2.293A1 1 0 005 16v0a1 1 0 001 1h11M9 19a2 2 0 104 0 2 2 0 00-4 0zm8 0a2 2 0 104 0 2 2 0 00-4 0z" />
                      </svg>
                      Add to Cart
                    </span>
                  )}
